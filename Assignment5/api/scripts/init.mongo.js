 ...
 * Atlas:
 *   mongo mongodb+srv://mongodb+srv://prane:prane@cluster0.w7fpa.mongodb.net/inventory?retryWrites=true&w=majority scripts/init.mongo.js
 * MLab:
...
const productsDB = [
  {
    id: 1,
    productName: 'Denim casual Jeans',
    pricePerUnit: 15,
    category: 'Jeans',
  ...
  {
    id: 2,
    productName: 'Men clothing Jacket',
    pricePerUnit: 50,
    category: 'Jackets',
  ...
  {
    id: 3,
    productName: "Men's Cotton Sweater",
    pricePerUnit: 30,
    category: 'Sweaters',
